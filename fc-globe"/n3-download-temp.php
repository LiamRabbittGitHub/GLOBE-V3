...
<div class="sender-info">
    <span class="fc_sender-title">Presented by</span>
    <span class="main-name fc-send fc-send-left">
        <?php if(isset($sender)){echo strtoupper($sender);} else{echo 'ZIGGY STARDUST';} ?>
    </span>
    <?php if(isset($serial)){ ?>
        <p>Serial Number: <?php echo $serial; ?></p>
    <?php } ?>
