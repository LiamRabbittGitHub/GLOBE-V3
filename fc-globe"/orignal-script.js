...
if (window.location.pathname == '/home/') {
	...
	fetch('http://theoneinamillionglobe.com/wp-json/image-api/image-item/').then((res) => res.text()).then((data) => {
		ApiImage = JSON.parse(data);
	});

	let Arr = [];
	let allCat;
	fetch('http://theoneinamillionglobe.com/wp-json/categories-api/categories-item/')
		.then((res) => res.text())
...
`;
	...
	function searchData() {
		...
		if (Cat) {
			isSearching = true;
			var url = new URL('http://theoneinamillionglobe.com/wp-json/search-cluster-api/search-item'),
				params = { ...Cat };
    ...
    <div id=content' class="modal-content">
                    ...
                    <div class="main-template">
                        <div class="content-template">
                            ...
                            <div>
                            <img src="http://theoneinamillionglobe.com/wp-content/uploads/2020/07/logo-mid.png">
                            </div>
  ...
  `;
	...
	var myGlobe = Globe()(document.getElementById('globeViz'))
		.globeImageUrl('http://theoneinamillionglobe.com/wp-content/uploads/2020/06/globeimg.gif')
		.backgroundImageUrl('http://theoneinamillionglobe.com/wp-content/uploads/2020/06/blackbg.png')
	...
	var getData = (CATEGORY) =>
		Promise.all([
			fetch('http://theoneinamillionglobe.com/wp-json/map-api/distance-item').then((res) => res.text())
		]).then(([ data ]) => {
